...
def calculates_results_stats(results_dic):
    ...
    # Process through the results dictionary to calculate the statistics
    for key in results_dic:
        ...
        # Count correct dog breeds (both pet label and classifier label are dogs and they match)
